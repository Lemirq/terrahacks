    ...
    const { data: sData, error } = await supabase
      ...
      .update({
        ...
        confidence: {
          ...
          confidence_web3_crypto_blockchain:
            data.confidence_web3_crypto_blockchain,
        },
...
All the data should be added to the 'confidence' object in the form data. */}
              <div className="w-full fc items-start gap-2 mt-5">
                ...
                <p className="text-sm">
                  If you're a beginner, don't worry! This hackathon is a great
                  place to learn and grow. If you're an expert, we'd love to see
                  what you can do!
                </p>
                  ...
                  {confidence.map((item: confidenceType) => {
                    ...
                    return (
                      <Controller
                        ...
                        render={({
                          field: { onChange, onBlur, value: broski },
                        }) => (
                          <Select
                            label={label}
                            placeholder="Select an option"
                ...
                <p>
                  Quick Tip: Use tab and the left/right arrow keys to select
                  quickly
                </p>
              </div>
            </Section>
