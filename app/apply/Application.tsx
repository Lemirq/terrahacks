...
const Application = ({ user }: { user: User }) => {
  ...
  const [socials, setSocials] = useState(new Set<string>([]));
  ...
  const errorMessages = {
    ...
    graduation:
      errors.graduation?.type === "required"
        ...
        : errors.graduation?.type === "pattern"
          ? "Enter a valid year"
          : errors.graduation?.type === "validate" &&
            "Enter a year after 2024 and before 2100",
    major: errors.major && "Major is required",
    attended_hackathons:
      errors.attended_hackathons && "Selecting an option is required",
    interests:
    ...
    confidence_front_end_dev:
      errors.confidence_front_end_dev && "Selecting an option is required",
    confidence_back_end_dev:
      errors.confidence_back_end_dev && "Selecting an option is required",
    confidence_fullstack_dev:
      errors.confidence_fullstack_dev && "Selecting an option is required",
    confidence_product_management:
      errors.confidence_product_management && "Selecting an option is required",
    confidence_ui_ux_design:
      errors.confidence_ui_ux_design && "Selecting an option is required",
    confidence_web3_crypto_blockchain:
      errors.confidence_web3_crypto_blockchain &&
      "Selecting an option is required",
    confidence_cybersecurity:
      errors.confidence_cybersecurity && "Selecting an option is required",
    confidence_ai_machine_learning:
      errors.confidence_ai_machine_learning &&
      "Selecting an option is required",

    // socials
    github:
      errors.github?.type === "validate" && "Enter a valid GitHub profile URL",
    twitter:
      errors.twitter?.type === "validate" &&
    ...
    short_answer1:
      errors.short_answer1?.type === "required"
        ...
        : errors.short_answer1?.type === "maxLength"
          ...
          : errors.short_answer1?.type === "validate"
    ...
    short_answer2:
      errors.short_answer2?.type === "required"
        ...
        : errors.short_answer2?.type === "maxLength"
          ...
          : errors.short_answer2?.type === "validate"
            ? "Input cannot be only spaces"
    ...
    <TracingBeam className="px-4 pl-6">
      <main className="w-full min-h-screen overflow-hidden relative py-36 fc justify-start">
        ...
        <div className="w-full fc items-start max-w-6xl mx-auto">
          ...
          <p className="text-neutral-100 font-bold mb-5">
            Only takes 30 seconds to apply!
          </p>
          <p className="text-neutral-300 mb-5">
            Please fill out all required fields to apply. Application will be
            automatically saved <b>on this device</b>.
          </p>
		...
		...register('phone_number', { required: false, pattern: /^[0-9]{3}-[0-9]{3}-[0-9]{4}$/ }),
              ...
              <Controller
                ...
                rules={{
                  ...
                  // larger than 2024
                  validate: (value) =>
                    parseInt(value) > 2024 && parseInt(value) < 2100,
                }}
                render={({ field: { onChange, onBlur, value } }) => (
                  <div className="fc gap-2 items-start w-full">
                    <Input
...
All the data should be added to the 'confidence' object in the form data. */}
            ...
            {/* <Controller
                ...
                rules={{
                  ...
                  minLength: 200,
                  validate: (value) =>
                    value.trim().length > 0 || "Input cannot be only spaces",
                }}
                render={({ field: { onChange, onBlur, value } }) => (
                  <div className="fc gap-2 items-start w-full">
                    <Textarea
            ...
            <Section
              title="Social"
              subheading="These aren't required, but they give us a glimpse of who you are."
            >
              <Select
                label="Select all socials you'd like to share"
                variant="bordered"
                selectionMode="multiple"
                placeholder="Select socials"
                selectedKeys={socials}
                className="max-w-xs"
                onSelectionChange={setSocials}
              >
              ...
              {socials.has("github") && (
                <Input
                  ...
                  {...registerGithub}
                  label="GitHub"
                  placeholder="https://github.com/elon_musk"
                />
              )}
              {socials.has("twitter") && (
                <Input
              ...
              {socials.has("linkedin") && (
                <Input
                  autoComplete="off"
                  {...registerLinkedIn}
                  label="LinkedIn"
                  placeholder="https://linkedin.com/in/elonmusk"
                />
              )}
              ...
              <Controller
                name="resume"
                control={control}
                render={({ field }) => <DnD {...field} user={user} />}
              />
            </Section>
