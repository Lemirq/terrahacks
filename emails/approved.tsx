				...
				<Container className="m-auto p-5 py-24 text-white">
					...
					<div className="text-lg text-neutral-200">
						...
						<Text className="text-lg">
							You have been accepted to participate in Hack49, our virtual global hackathon. Your application stood out among many, and
							we are excited to see what innovative solutions you will bring to the table.
						</Text>
						<Text className="text-lg">
							Event Details:
						...
						<Text className="text-lg">
							...
							<ol>
								...
								<li>Prepare for the Event: Familiarize yourself with the schedule and the resources provided.</li>
							</ol>
						</Text>
						<Text className="text-lg">
						...
						<Text className="text-lg">For any questions or further information, reach out to us at [Your Contact Information].</Text>
