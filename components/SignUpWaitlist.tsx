...
const SignUpForm = () => {
  ...
  return (
    <form className="fc gap-2 w-full items-start" onSubmit={handleSubmit}>
      <h3 className="text-neutral-400 text-center text-lg">
        Join the Hack49 waitlist!
      </h3>
  ...
  return (
    ...
    >
      ...
      <p className="text-neutral-400 my-2 text-base sm:text-xl">
        Hack49 is a yearly international hackathon dedicated to fostering the
        creation of groundbreaking solutions to address the world's most complex
        issues.
      </p>
      {timeLeft && (
      ...
      >
      	...
      	<div
      		className="px-12 py-2 fr text-xl gap-2 bg-black rounded-[6px]  relative group transition duration-200 text-white hover:bg-transparent">
