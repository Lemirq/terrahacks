...
const Hero = () => {
	...
	return (
		<section id="hero" className="w-screen overflow-x-hidden h-full">
			<AuroraBackground className="w-full fc sm:items-start relative z-10 min-h-screen md:pt-10 px-5 sm:px-10 pb-10">
				<SignUpWaitlist />
